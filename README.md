...
- MPV (optional, required for streaming)
...
- Fast searching
- Streaming using MPV
	- download MPV at https://mpv.io/installation/
...
by choosing a show and an episode range you want to watch, gogo-dl will launch MPV, and the show will start downloading
...
by choosing a show and an episode range you want to watch, gogo-dl will launch MPV, and the show will start playing
...
#### fetches all the episodes and adds them in a queue into your media player(MPV)
